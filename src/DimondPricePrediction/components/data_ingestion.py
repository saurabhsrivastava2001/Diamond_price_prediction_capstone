...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logger.log(level=logger.INFO, msg="data ingestion started")
        
        try:
            data=pd.read_csv(Path(os.path.join("notebooks/data","train.csv")))
            logger.info(" i have read dataset as a df")
            ...
            logger.info("here i have performed train test split")
           ...
           logger.info("exception during occured at data ingestion stage")
